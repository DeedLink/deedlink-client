const WhyChooseSection = () => {
  const features = [
    ...
    "Secure & Transparent: Leveraging advanced security protocols and blockchain technology, we ensure data integrity and prevent fraudulent activities.",
    ...
    "Cost Savings: Experience significant cost savings through streamlined and efficient processes.",
  ];

  return (
    <section className="w-full px-6 md:px-10 py-16 text-black">
